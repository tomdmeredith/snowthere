...
export default async function ResortsPage() {
  ...
  return (
    <main className="min-h-screen bg-cream-50">
      ...
      <nav className="bg-cream-100 py-4 border-b border-cream-200">
        <div className="container-page">
          <ol className="breadcrumb">
            ...
            <li className="text-slate-900 font-medium">Resorts</li>
          </ol>
        </div>
      </nav>
      ...
      <header className="hero py-16 sm:py-20">
        <div className="container-page relative z-10">
          <div className="animate-in animate-in-1 max-w-2xl">
            <span className="font-accent text-2xl text-glow-300 block mb-3">
              Find your perfect family resort
            </span>
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-cream-50 tracking-tight">
              Browse Family Ski Resorts
            </h1>
            <p className="mt-6 text-lg text-forest-200 leading-relaxed">
              {resorts.length > 0 ? (
                <>
                  <strong className="text-cream-50">{resorts.length}</strong> family-friendly resorts worldwide with complete trip guides, cost breakdowns, and honest parent reviews.
                </>
              ) : (
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 max-w-xl animate-in animate-in-2">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-full bg-white/10 border border-forest-600 text-cream-50 placeholder-forest-300 focus:outline-none focus:ring-2 focus:ring-glow-400 focus:border-transparent transition-all"
              />
            </div>
      ...
      <div className="container-page py-12 lg:py-16">
        {countries.length === 0 ? (
          <div className="text-center py-16">
            <div className="mx-auto w-16 h-16 rounded-2xl bg-cream-100 flex items-center justify-center mb-6">
              ...
              <section key={country} className="animate-in animate-in-3">
                ...
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  {grouped[country].map((resort) => (
                    ...
                    >
                      {/* Placeholder image */}
                      <div className="aspect-[16/9] rounded-xl bg-gradient-to-br from-forest-100 to-forest-200 mb-4 overflow-hidden">
                        <div className="w-full h-full flex items-center justify-center">
                          <Mountain className="w-12 h-12 text-forest-300 group-hover:scale-110 transition-transform duration-300" />
                        </div>
                      </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {resort.family_metrics?.family_overall_score && (
                          <div className="flex items-center gap-1 bg-glow-100 text-glow-700 px-2.5 py-1 rounded-full text-sm font-semibold shrink-0">
                      ...
                      {resort.family_metrics?.best_age_min && resort.family_metrics?.best_age_max && (
                        <p className="mt-3 text-sm text-slate-600 flex items-center gap-1">
      ...
      {/* Newsletter CTA */}
      <section className="bg-cream-100 border-t border-cream-200 py-16">
        <div className="container-page">
          ...
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="text-center sm:text-left">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Family ski guides made with ❤️ for ski families.
              </p>
            </div>

            <div className="flex flex-wrap justify-center gap-6">
              <Link href="/" className="text-sm text-slate-600 hover:text-glow-600 transition-colors">
                Home
              </Link>
